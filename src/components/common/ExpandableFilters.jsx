...
function ExpandableFilters({ buttonText, TopPart, ExpandablePart, BottomPart }) {
  ...
  return (
    <Grid component={Card} container className="p-2 mb-4 mt-2 align-center">
      ...
      <Grid item xs={3} className="d-flex justify-center">
        <Button variant="text" onClick={toggleExpand}>{!expandedFilters ? buttonText[0] : buttonText[1]}</Button>
      </Grid>
