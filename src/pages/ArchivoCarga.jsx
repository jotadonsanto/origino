    ...
    <Grid container spacing={2}>
      ...
      <Grid item xs={12} className="mt-3">
        <span className="d-flex flex-row align-center mb-2">
          <Typography variant="body2" component="h3" color="text.primary">Si no tenes el excel, podes descargalo aca:</Typography>
          <FontAwesomeIcon icon={faInfoCircle} className="ml-1" color="#61B15A" onClick={showNewFileTooltip} />
          <Popover
            id={NewFileTooltipId}
            open={newFileTooltip}
            ...
            <Card className="p-2 d-flex flex-column">
                ...
                <div className="d-flex mt-2 justify-end">
                  <Button variant="outlined" onClick={closeNewFileTooltip}>Entendido</Button>
                </div>
            </Card>
          </Popover>
        </span>
      ...
      <Grid item xs={6} xl={3} className="d-flex">
        <Card className="d-flex flex-column flex p-3">
          <Typography variant="h6" component="h4" color="text.light">Subí tu excel<br/>precargado</Typography>
          <Divider variant="middle" className="mr-0 ml-0 mt-2 mb-2"/>
          <Typography variant="caption" component="h6" color="text.light" className="mb-2">Si ya tenés el archivo completo, cargalo directamente.</Typography>
      ...
      <Grid item xs={6} xl={3} className="d-flex">
        <Card className="d-flex flex-column flex p-3">
          <Typography variant="h6" component="h4" color="text.light">Subí las<br/>caravanas</Typography>
          <Divider variant="middle" className="mr-0 ml-0 mt-2 mb-2"/>
          <Typography variant="caption" component="h6" color="text.light" className="mb-2">Si necesitás crear solo un activo, podés hacerlo directamente presionando “+”.</Typography>
      ...
      <Grid item xs={6} xl={3} className="d-flex">
        <Card className="d-flex flex-column flex p-3">
          <Typography variant="h6" component="h4" color="text.light">Creá una plantilla<br/>nueva</Typography>
          <Divider variant="middle" className="mr-0 ml-0 mt-2 mb-2"/>
          <Typography variant="caption" component="h6" color="text.light" className="mb-2">Si ya tenés el archivo completo, cargalo<br/>directamente.</Typography>
          <StyledIconButton size="large" className="align-self-center">
            <FontAwesomeIcon icon={faPlus} />
          </StyledIconButton>
        </Card>
      ...
      <Grid item xs={6} xl={3} className="d-flex">
        <Card className="d-flex flex-column flex p-3">
          <Typography variant="h6" component="h4" color="text.light">Cargá un activo de<br/>forma individual.</Typography>
          <Divider variant="middle" className="mr-0 ml-0 mt-2 mb-2"/>
          <Typography variant="caption" component="h6" color="text.light" className="mb-2">Si necesitás crear solo un activo, podés hacerlo directamente presionando “+”.</Typography>
          <StyledIconButton size="large" className="align-self-center">
            <FontAwesomeIcon icon={faPlus} />
