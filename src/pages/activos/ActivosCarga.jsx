...
import ActivoAddedModal from '../../components/activos/ActivoAddedModal';
...
function ActivosCarga() {
  ...
  // For ActivoAddedModal
  const [activoAddedModal, setActivoAddedModal] = React.useState(false);
  const toggleActivoAddedModal = (value) => {
    setActivoAddedModal(value);
  };
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} className="mt-4">
          <Stack
            ...
            <Button className="ml-1" variant="contained" onClick={() => toggleActivoAddedModal(true)}>CONTINUAR</Button>
          </Stack>
        </Grid>
      </Grid>
      <ActivoAddedModal open={activoAddedModal} toggleModal={toggleActivoAddedModal} />
    </React.Fragment>
  );
}
